class AboutsController < ApplicationController
  ...
  # GET /abouts.json
  def index
    @abouts =  current_user.about
    if About.where(:user_id => current_user.id).present?
         abouts_path
     else
  ...
  private
    ...
    def about_params
      params.require(:about).permit(:aboutinfo, :shopname, :shopimg,:shopimg1, :shopimg2, :shopimg3, :user_id)
    end
end
